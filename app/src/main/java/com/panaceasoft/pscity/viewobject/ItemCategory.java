...
public class ItemCategory {
    ...
    public ItemCategory(int sorting, String id, String name, String ordering, String status, String addedDate, String updatedDate, String addedUserId,
                        String cityId,
                        String updatedUserId, String updatedFlag, String addedDateStr, Image defaultPhoto, Image defaultIcon) {
